 ...
 <body style="background-color: #3498DB;">
  ...
  <nav class="navbar navbar-default navbar-lg" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <a href="<?php echo base_url('user'); ?>" class="navbar-left"><img class="img-circle" src="<?php echo base_url('assets/img/icons/icon.png'); ?>" style="max-width:85px; max-height:80px;margin-top: 5px"></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-01">
      ...
      <div class="navbar-right">
        ...
        <li>
          <a href="<?php echo base_url('resume'); ?>"><?php echo $email_address; ?></a>
        </li>
        <li class="dropdown">
