      ...
      <div class="row">
        <div class="col-lg-offset-3 col-lg-6 col-xs-12">
          <div class="form-group">
            ...
            <div>
              <?php echo form_error('companysize', '<small class="text-danger">', '</small>'); ?>
            </div>
      ...
      <div class="row">              
        <div class="col-lg-offset-3 col-lg-6 col-xs-12">
          <div class="form-group">
            ...
            <input type="text" name="companyemail" class="form-control"  value="<?php echo $company_email;?>">
            <small class="text-muted">You can Edit the email where the resume's are to be sent.</small>
            <div>
              <?php echo form_error('companyemail', '<small class="text-danger">', '</small>'); ?>
            </div>
          </div>
        </div>
      </div>
