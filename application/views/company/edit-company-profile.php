...
<div class="container well" style="background-color: white; padding-top: 0px;">
    <br>
    <div class="row">
      <div class="col-lg-offset-3 col-lg-6 col-xs-12">
        <div class="tile">
          <h4 class="text-center " style="margin: 2px;">Edit <?php echo $company_name;?> Information</h4>
        </div>              
      </div>
    </div>
    ...
    <form method="POST" action="<?php echo base_url('company/validate_profile'); ?>">
      ...
      <div class="row">              
        <div class="col-lg-offset-3 col-lg-6 col-xs-12">
          <!-- <div class="form-group"> -->
            <label>Company Email <span class="text-danger">*</span> <?php echo form_error('companyaddress', '<small class="text-danger">', '</small>'); ?></label>
            <input type="text" name="companyemail" class="form-control"  value="<?php echo $email_address;?>">
            <small class="text-muted">You can Edit the email where the resume's are to be sent.</small>
      ...
      <div class="row">    <!--  col-lg-6 col-xs-12   -->     
          ...
          <div class="col-lg-offset-3 col-lg-6 col-xs-12 text-right  "><p></p>
            ...
            <div class="row">
              <div class="col-md-3" > 
                <button class="btn btn-info" type="submit" href="<?php echo base_url();?>company/view_company_profile">Back to Profile</button>
              </div>
              <div class="col-md-3 ">
